	...
	const features = [
		{
			...
			desc: "Tailored responses to your business challenges",			icon: (
				<svg
					width="81"
					height="81"
					viewBox="0 0 81 81"
		...
		{
			title: "Expert advice",
			desc: "Get insights from experienced professionals",
			icon: (
				<svg
					width="80"
					height="81"
		...
		},
		{
			...
			desc: "Plan for long‑term success",
			icon: (
				<svg
					width="80"
					height="81"
		...
		},
		{
			...
			desc: "Optimize how your business works",
			icon: (
				<svg
					width="80"
					height="81"
