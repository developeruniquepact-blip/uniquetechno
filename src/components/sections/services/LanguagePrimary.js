"use client";
import ServiceCard2 from "@/components/shared/cards/ServiceCard3";
import Paginations from "@/components/shared/others/Paginations";
import usePagination from "@/hooks/usePagination";
import getLanguageServices from "@/libs/getLanguageServices";
import makeWowDelay from "@/libs/makeWowDelay";

const LanguagePrimary = () => {
	const items = getLanguageServices();
	const limit = 6;
...
export default LanguagePrimary;
